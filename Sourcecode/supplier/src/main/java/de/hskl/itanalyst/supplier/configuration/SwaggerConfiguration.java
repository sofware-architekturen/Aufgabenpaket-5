package de.hskl.itanalyst.supplier.configuration;
...
public class SwaggerConfiguration {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .paths(PathSelectors.ant("/orderBook"))
                .build()
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                "REST API für den Buchlager-Lieferanten",
                "Software-Architekturen: Buchlager-Lieferantenservice",
                "1.0",
                "Nutzungsbedingungen",
